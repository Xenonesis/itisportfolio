...
export function GitHubContributions() {
  ...
  const getContributionColor = (level: number) => {
    ...
    const colors = [
      ...
      "bg-emerald-200 dark:bg-emerald-900/50", // Level 1
      "bg-emerald-400 dark:bg-emerald-700/60", // Level 2
      "bg-emerald-500 dark:bg-emerald-500/70", // Level 3
  ...
  return (
    <section className="mb-10">
      <AnimateIn variant="reveal" delay={0.7}>
        <h2 className="text-lg font-medium tracking-tight mb-4 inline-flex items-center gap-2">
          <svg
      ...
      <AnimateIn variant="fadeUp" delay={0.75}>
        ...
        <div className="relative bg-white dark:bg-zinc-950 rounded-xl p-4 sm:p-6 border border-zinc-200 dark:border-zinc-800 overflow-hidden mb-4 shadow-sm hover:shadow-md transition-shadow">
          {/* Month Labels */}
      ...
      <AnimateIn variant="fadeUp" delay={0.85}>
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
          {/* Followers */}
          <div className="relative bg-white dark:bg-zinc-950 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 text-center hover:border-blue-300 dark:hover:border-zinc-600 hover:shadow-md transition-all group">
          ...
          {/* Public Repos */}
          <div className="relative bg-white dark:bg-zinc-950 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 text-center hover:border-pink-300 dark:hover:border-zinc-600 hover:shadow-md transition-all group">
            <div className="flex justify-center mb-2">
          ...
          {/* Contributions */}
          <div className="relative bg-white dark:bg-zinc-950 rounded-xl p-4 border border-zinc-200 dark:border-zinc-800 text-center hover:border-emerald-300 dark:hover:border-zinc-600 hover:shadow-md transition-all group">
            <div className="flex justify-center mb-2">
